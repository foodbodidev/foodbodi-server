...
const licenseToken = require("../middlewares/license_permission_token_verifier");
...
router.get("/approve", licenseToken, licenseController.approve);

router.get("/deny", licenseToken, licenseController.deny);
